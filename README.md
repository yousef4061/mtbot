...
نوشتن مستندات کامل و کامنت‌های مناسب.
مدولار کردن ربات با ConversationHandler برای جریان‌های پیچیده.

این ربات نقطه شروع عالی برای درک API بات تلگرام و برنامه‌نویسی异步 پایتون است.
مشارکت
مشارکت‌ها خوش‌آمدند! Issues و Pull Requestها را باز کنید.
لایسنس
MIT License - آزادانه برای یادگیری استفاده کنید.
text---
